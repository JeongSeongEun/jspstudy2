...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar">
            ...
            <c:if test="${empty sessionScope.login}">
                <span>Welcome, <strong>로그인하세요</strong></span>
            </c:if>
            <br>
        </div>
    </div>
    ...
    <div class="w3-bar-block">
        ...
        <a href="${path}/model2/member/main.me" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i> 
            회원관리</a>
        <a href="${path}/model2/board/list.do" class="w3-bar-item w3-button w3-padding"><i
                class="fa fa-users fa-fw"></i>  게시판</a>
        <a href="${path}/model2/chat/chatform.do" class="w3-bar-item w3-button w3-padding"><i
                class="fa fa-bullseye fa-fw"></i>  채팅</a>
    </div>
</nav>
